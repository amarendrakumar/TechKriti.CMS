...
namespace Techkriti.Common.Utilities
{
    public class RandomImage
    {
        ...
        { 
            this.text = SessionWrapper.CaptchaImageText;
        ...
        {
            if (width <= 0) throw new ArgumentOutOfRangeException("width", width, "Argument out of range, must be greater than zero.");
            if (height <= 0) throw new ArgumentOutOfRangeException("height", height, "Argument out of range, must be greater than zero.");
