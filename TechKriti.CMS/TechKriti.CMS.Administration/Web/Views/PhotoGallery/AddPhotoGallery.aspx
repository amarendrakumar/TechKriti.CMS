                    ...
                    <td>                      
                        <table border="0" style="border: dashed;width:70%;">                            
                            ...
                            <tr>
                                ...
                                <td>
                                    <techKriti:ButtonControl ID="btnSave" runat="server" Text="Save" onClick="btnSave_Click" RequiredActionPermission="UpdatePhotoGallery"  />
                                    <techKriti:ButtonControl ID="btnUpdate" Text="Update" runat="server" OnClick="btnSave_Click" RequiredActionPermission="DeletePhotoGallery" />                                     
