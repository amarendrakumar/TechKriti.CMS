...
namespace TechKriti.CMS.Administration.Web.Views.CMS
{
    public partial class AddPage : BasePage
    {
        ...
        private void BuildView()
        {
            ...
            txtDescription.Text = PageModel.Description;
            txtMetaKeys.Text = PageModel.MetaKeys;
            txtH1.Text = PageModel.H1;
            txtH2.Text = PageModel.H2;
            txtSeoTitle.Text = PageModel.SeoTitle;
        ...
        private void ClearForm()
        {
            ...
            txtTitle.Text = txtContent.Text = txtDescription.Text = txtMetaKeys.Text = txtH1.Text = txtH2.Text = txtSeoTitle.Text = string.Empty;
        }
        ...
        private void BuildPageRequest()
        {
            ...
            PageModel.Description = txtDescription.Text;
            PageModel.MetaKeys = txtMetaKeys.Text;
            PageModel.H1 = txtH1.Text;
            PageModel.H2 = txtH2.Text;
            PageModel.SeoTitle = txtSeoTitle.Text;
        }
