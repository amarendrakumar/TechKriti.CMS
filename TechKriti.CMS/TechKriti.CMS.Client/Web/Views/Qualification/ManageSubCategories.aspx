<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageSubCategories.aspx.cs" Inherits="TechKriti.CMS.Client.Web.Views.Qualification.ManageSubCategories"
    ...
    <asp:UpdatePanel ID="uptPanelManageSubCategories" runat="server">
        <ContentTemplate>
            ...
            <h1 class="page-header">Categories
                  <techKriti:HyperlinkControl ID="linkAddSubCategory" CssClass="btn btn-danger" Text="Add Category" runat="server" RequiredActionPermission="AddSubCategory" />
            </h1>
            <asp:Label ID="lblStatus" CssClass="alert alert-info" Style="display: table;" runat="server" Visible="false"></asp:Label>
			 ...
			 <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <asp:Button ID="btnQualificationSearch" CssClass="btn btn-primary" runat="server" Text="Search"  OnClick="btnSubCategorySearch_Click"  />
                    </div>
                </div>
            </div>
