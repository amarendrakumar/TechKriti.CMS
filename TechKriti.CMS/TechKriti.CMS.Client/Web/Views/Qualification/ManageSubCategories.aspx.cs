...
{
    public partial class ManageSubCategories : BasePage
    {      
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                linkAddSubCategory.NavigateUrl = Pages.AddSubCategory;
                RefreshCategories(0);               
            } 
        }
        ...
        private void RefreshCategories(int? startIndex)
        {
            try
            {
                ...
                QualificationsController.GetSubCategories( txtSearchSubCategoryName.Text, txtSearchCode.Text, startIndex, PageSize, 
                                                           default(Nullable<int>),out totalNumberOfRecords );
        ...
        protected void gridCategories_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == EditCommandName) Response.Redirect(Pages.AddSubCategory + "?categoryId=" + categoryId);
        ...
        private void DeleteCategory(int categoryId)
        {
            try
            {
                ...
                bool isDeleted = QualificationsController.DeleteSubCategory(categoryId, out errorMessage);
        ...
        protected void btnSubCategorySearch_Click(object sender, EventArgs e) { RefreshCategories(0); }
