...
namespace TechKriti.CMS.Client.Web.Shared
{
    public abstract class BasePage : System.Web.UI.Page, IAuthorizeAction
    {
        ...
        protected bool SaveSection(string sectionName, SectionType type)
        {
            return DownloadsController.SaveSection(new Datacontracts.SectionManagement.SectionDataContract { Name = sectionName, SectionType = type });
        }
